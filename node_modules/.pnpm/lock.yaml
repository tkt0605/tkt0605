...
packages:
  ...
  prettier-plugin-jinja-template@2.2.0:
    resolution: {integrity: sha512-FVZtWvSW8RKvHToWHgI9j1eau7t2mekYoVKg7GdDS16QVOYM8f08yzVptBUvSXKQR2xJAXCLi0rGGvJGFtCUrA==}
    peerDependencies:
      prettier: ^3.0.0
...
snapshots:
  ...
  prettier-plugin-jinja-template@2.2.0(prettier@3.8.4):
    dependencies:
      prettier: 3.8.4
